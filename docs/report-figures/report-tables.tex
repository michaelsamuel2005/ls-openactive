% Paste-ready tables for the Group 41 report (Execution section).
% Requires: \usepackage{booktabs}  (and \usepackage{graphicx} for the figure).
% Data generated from the branch clarence/c-block-05 on 2026-08-14; all runs green (14 suites).
% Figure: \includegraphics{architecture-two-projections.pdf}  % convert the .svg to .pdf/.png first.

% ---------------------------------------------------------------------------
% Table: certificate checker negative cases (Section 3.2)
\begin{table}[t]
\centering
...
% ---------------------------------------------------------------------------
% Table: field-level disclosure classes (Section 3.6)
\begin{table}[t]
\centering
...
% ---------------------------------------------------------------------------
% Table: release-blocking invariants (Section 3.6)
\begin{table}[t]
\centering
...
% ---------------------------------------------------------------------------
% Table: staff role -> capability matrix (Section 3.5)
\begin{table}[t]
\centering
...
% ---------------------------------------------------------------------------
% Table: executable assurance case, 15 claims (Section 3.6 / Critical Evaluation)
\begin{table}[t]
\centering
